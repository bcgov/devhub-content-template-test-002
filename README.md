[![Package Status](https://github.com/bcgov/devhub-content-template-test-002/actions/workflows/publish.yaml/badge.svg)](https://github.com/bcgov/devhub-content-template-test-002/actions/workflows/publish.yaml)
